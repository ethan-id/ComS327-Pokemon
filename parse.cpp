...
std::vector<typeNames> allTypeNames;
...
std::vector<pokemonStats> allPokemonStats;
std::vector<pokemonTypes> allPokemonTypes;
...
void readFile(string fileName) {
    ...
    if(strcmp(validNames[dataType], "stats") == 0) {
        ...
        for (auto & element : seglist) {
            ...
            while ((pos = element.find(delimiter)) != std::string::npos) {
                ...
                switch(elementPos) {
                    ...
                    case 1 :
                        try {
                            statsObj.damage_class_id = stoi(token);
                        } catch(exception& e) {
                            statsObj.damage_class_id = INT_MAX;
                        }
                        break;
                    case 2 :
                    ...
                    case 3 :
                        try {
                            statsObj.is_battle_only = stoi(token);
                        } catch(exception& e) {
                            statsObj.is_battle_only = INT_MAX;
                        }
                        break;
                }
                elementPos++;
            ...
            try {
                statsObj.game_index = stoi(token);
            } catch(exception& e) {
                statsObj.game_index = INT_MAX;
            }
            allStats.push_back(statsObj);
        }
        ...
        //     cout << "Is Battle Only: " << (element.is_battle_only == INT_MAX ? "" : std::to_string(element.is_battle_only)) << endl;
        //     cout << "Game Index: " << (element.game_index == INT_MAX ? "" : std::to_string(element.game_index)) << endl;
        //     cout << "\n";
        // }
    }
    ...
    if(strcmp(validNames[dataType], "pokemon") == 0) {
        ...
        for (auto & element : seglist) {
                ...
                switch(elementPos) {
                    ...
                    case 5 :
                        try {
                            ...
                            pokemonObj.base_experience = INT_MAX;
                        }
                        break;
                    case 6 :
                        try {
            ...
            try {
                ...
                pokemonObj.is_default = INT_MAX;
            }
            allPokemon.push_back(pokemonObj);
        }
    ...
    if(strcmp(validNames[dataType], "type_names") == 0) {
        ...
        for (auto & element : seglist) {
            ...
            allTypeNames.push_back(typeNameObj);
        }
    ...
    if(strcmp(validNames[dataType], "experience") == 0) {
        ...
        for (auto & element : seglist) {
            ...
            allExperience.push_back(expObj);
        }
    ...
    if(strcmp(validNames[dataType], "pokemon_moves") == 0) {
        ...
        for (auto & element : seglist) {
            ...
            allPokemonMoves.push_back(pokemonMoveObj);
        }
    ...
    if(strcmp(validNames[dataType], "pokemon_species") == 0) {
        ...
        for (auto & element : seglist) {
            ...
            allPokemonSpecies.push_back(speciesObj);
        }
    ...
    if(strcmp(validNames[dataType], "pokemon_stats") == 0) {
        ...
        for (auto & element : seglist) {
            ...
            allPokemonStats.push_back(statsObj);
        }
    ...
    if(strcmp(validNames[dataType], "pokemon_types") == 0) {
        ...
        for (auto & element : seglist) {
            ...
            allPokemonTypes.push_back(typesObj);
        }
